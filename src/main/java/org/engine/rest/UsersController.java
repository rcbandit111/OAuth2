...
public class UsersController {
    ...
    @Autowired
    public UsersController(UsersService usersService, UserRestService userRestService,
                           UserMapper userMapper, PasswordAdminResetHandler resetHandler,
                           ValidationMessage validationMessage, JwtTokenUtil jwtTokenUtil,
                           OldPasswordsService oldPasswordsService, PasswordEncoder passwordEncoder){
    ...
    public ResponseEntity<?> resetToken(@Valid @RequestBody ResetPasswordTokenDTO resetPasswordTokenDTO, BindingResult bindResult) {
        ...
        final String login = jwtTokenUtil.getUsernameFromToken(resetPasswordTokenDTO.getResetPasswordToken());
    ...
    public ResponseEntity<?> resetPassword(@Valid @RequestBody ResetPasswordDTO resetPasswordDTO) {
        ...
        final String login = jwtTokenUtil.getUsernameFromToken(resetPasswordDTO.getResetPasswordToken());
